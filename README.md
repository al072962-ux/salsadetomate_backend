...
erDiagram
    ...
    users ||--o{ recipe_ratings : "califica"
    users ||--o{ recipe_comments : "comenta"
    users ||--o{ recipe_likes : "da like"
    users ||--o{ collections : "crea"
    users ||--o{ follows : "seguidor"
    users ||--o{ follows : "seguido"
    users ||--o{ personal_access_tokens : "auth"

    recipes ||--o{ recipe_ingredients : "tiene"
    recipes ||--o{ recipe_steps : "tiene"
    recipes ||--o{ recipe_media : "tiene"
    recipes ||--o{ recipe_ratings : "recibe"
    recipes ||--o{ recipe_comments : "recibe"
    recipes ||--o{ recipe_likes : "recibe"
    recipes }o--o{ categories : "category_recipe"
    recipes }o--o{ collections : "collection_recipes"
    recipes }o--o| recipe_media : "main_image"

    recipe_comments ||--o{ recipe_comments : "respuestas"
    ...
    recipes {
        ...
        enum video_type "upload | youtube"
        string video_url
        json nutrition
        timestamps created_at
    }
    ...
    recipe_ratings {
        ...
        tinyint stars
        text review
        boolean turned_out_well
        text changes
        boolean would_cook_again
        timestamps created_at
    }
